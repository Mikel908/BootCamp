...
statement_one = "Programmers: " + first_name + " " + last_name + " " + "is a " + nationatlity + " " + profession + " " + "born in: "  + str(birth_year) + "."
print(statement_one)
...
statement_three = "In " + str(year_of_publish) + " " + "she published the first Algorithm, the " + first_algorithm + ", at the age of 27"
...
statement_four = "She was a " + nationatlity +" Citizen when lived in " + city_location + "," + country_location + " until her passing in " + str(death_year) + " at the age of " + str(age_at_passing)
